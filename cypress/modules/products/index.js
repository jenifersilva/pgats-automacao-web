...
class Products {
  elements = {
    ...
    recommendedAddToCartBtn: () =>
      cy.get('#recommended-item-carousel > .carousel-inner > .active .add-to-cart'),
  };
  ...
  checkSearchedProducts() {
    this.elements.productsListTitle().should('have.text', titles.searched_products);
  ...
  checkProductInformation() {
    ...
    this.elements.productCategoryLbl().should('be.visible').should('not.be.empty');
    this.elements.productPriceLbl().should('be.visible').should('not.be.empty');
    this.elements.productAvailabilityLbl().should('be.visible').should('not.be.empty');
    this.elements.productConditionLbl().should('be.visible').should('not.be.empty');
